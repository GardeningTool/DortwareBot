package dev.gardeningtool.dortwarebot.listener.jda;

import dev.gardeningtool.dortwarebot.event.EventBus;
import dev.gardeningtool.dortwarebot.event.impl.*;
...
public class JDAListener extends ListenerAdapter {
    ...
    public void onGatewayPing(@NotNull GatewayPingEvent event) {
        eventBus.post(new EventBotStartup(event.getOldPing(), event.getNewPing()));
    }
